...
Posterior photometric-based cuts includes colour outliers in $g-r$ and $r-z$ and some quality cuts that relies on the low accuracy in its flux measurement. Such quality cuts are based on \FRACMASK, \FRACFLUX and \FRACIN \TRACTOR outputs in any of the three bands.
